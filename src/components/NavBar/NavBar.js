    ...
    return (
        <nav className='navbar'>
            ...
            <div className="components">
                ...
                <Link activeClass='active' to='about' spy={true} smooth={true} offset={-90} duration={500} className="componentsList">About</Link>
                <Link activeClass='active' to='skills' spy={true} smooth={true} offset={-70} duration={500} className="componentsList">Skills</Link>
                <Link activeClass='active' to='experience' spy={true} smooth={true} offset={-90} duration={500} className="componentsList">Experience</Link>
